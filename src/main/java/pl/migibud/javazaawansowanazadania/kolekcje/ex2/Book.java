...
public class Book implements Comparable<Book> {
    ...
    public boolean equals(Object o) {
        ...
        Book book = (Book) o;
        return Float.compare(book.price, price) == 0 && yearOfRelease == book.yearOfRelease && Objects.equals(title, book.title) && Objects.equals(authors, book.authors) && genre == book.genre;
    }
